...
class TwigAsseticIntegrationTokenParser extends AsseticTokenParser
{
    private $app;
    private $factory;
    private $tag;
     ...
     */
    public function __construct(AssetFactory $factory, $tag, $output, $single = false, array $extensions = array(), $app = null)
    {
    ...
    protected function loadFilters ($filters) {
        ...
        foreach ($filters as $filter) {
            ...
            if (isset ($optionFilters[$filter]))
                ...
                $this->app['assetic.filter_manager']->set ($filter, new $filterClass ());
            }
        }
